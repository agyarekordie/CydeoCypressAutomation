// Order of operators in JS in JS is same with Java
...
console.log(one === one_string); //false: looking for both value and datType
console.log(one_string === two_string); //false

//logical operators is same as Java: you have only short circuit &&, ||
